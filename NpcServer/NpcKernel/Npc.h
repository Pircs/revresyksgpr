...
public: // get
	...
	uint64			GetEffect()			{ return m_i64Effect; }
...
public: // set (call by msguserattrib)
	...
	void		SetEffect(uint64 i64Effect)		{ m_i64Effect = i64Effect; }
...
protected: // state
	int			m_nPosX, m_nPosY;
	uint64			m_i64Effect;			// enum { STATUS_NORMAL=0, STATUS_FREEZE, STATUS_DIE };
	int			m_nDir;
	int			m_nPose;
	CGameMap*		m_pMap;
