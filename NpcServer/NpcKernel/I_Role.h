...
const uint64		KEEPEFFECT_FREEZE			=0x00000400;    // 僵化 -- 也可以认为是冰冻
...
const uint64		KEEPEFFECT_SLOWDONE1		=0x00400000;    // 减速状态 50%
const uint64		KEEPEFFECT_SLOWDONE2		=0x00800000;	// 减速状态 // 血少于一半时开始减速 // 50%
...
// 综合状态
//enum {
const uint64		KEEPEFFECT_NOT_ACTIVE		=KEEPEFFECT_DIE|KEEPEFFECT_FREEZE|KEEPEFFECT_FAINT;
const uint64		KEEPEFFECT_NOT_BLOCKNPC		=KEEPEFFECT_GHOST;
//		KEEPEFFECT_NOT_VIRTUOUS		=KEEPEFFECT_RED|KEEPEFFECT_DEEPRED|KEEPEFFECT_CRIME,
const uint64		KEEPEFFECT_NOT_VIRTUOUS		=KEEPEFFECT_DEEPRED|KEEPEFFECT_CRIME;
//};
class CGameMap;
class CUser;
class CNpc;
...
*/	virtual void		SetLife(int nData)							PURE_VIRTUAL_FUNCTION
	...
	virtual void		SetEffect(uint64 i64Effect)					PURE_VIRTUAL_FUNCTION
