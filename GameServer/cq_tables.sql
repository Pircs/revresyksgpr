...
# by huihuui   id int(4) unsigned NOT NULL default '0' auto_increment,
# by huihuui   name varchar(15) binary NOT NULL default '未命名',
DROP TABLE IF EXISTS cq_dynamap;
CREATE TABLE cq_dynamap (
  id int(4) unsigned NOT NULL auto_increment,
  name varchar(16) binary NOT NULL default '未命名',
  describe_text varchar(127) binary NOT NULL default '',
...
CREATE TABLE cq_point_allot (
  ...
  level int(4) unsigned zerofill NOT NULL default '0000',
  force1 int(4) unsigned zerofill NOT NULL default '0000',
