...
//	virtual	BOOL	CheckStatus			(int nStatus);
	virtual uint64		GetEffect			()				{ return m_i64Effect; }
...
//	virtual DWORD	GetMagicAtk			()				{ return 0; }
	...
	virtual void	BroadcastRoomMsg(Msg* pMsg, bool bSendSelf = false);
	virtual void	BroadcastRoomMsg(LPCTSTR szMsg, bool bSendSelf = false);
	virtual void	BroadcastMapMsg(Msg* pMsg, bool bSendSelf = false);
