...
protected:
	...
	virtual ~CSyndicate();
public:
	static CSyndicate* CreateNew() { ASSERT(!"CSyndicate::CreateNew()"); return NULL; }				// 用于CSyndicate*
...
public: // const
	...
	void	BroadcastSynMsg(Msg* pMsg, CUser* pExcludeSender=NULL);
...
protected:
	...
	void	BroadcastLocalSynMsg(Msg* pMsg, CUser* pExcludeSender=NULL);
...
public:
	...
	bool	AllotBonusForMember(CUser* pUser,DWORD dwBonus);
	bool	ApplyKickoutMember(CUser* pLeader,CUser* pTarget);
	int		GetSubSynNum();
