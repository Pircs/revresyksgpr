...
// 在本地线程广播子帮派消息
void CSyndicate::BroadcastLocalSynMsg(Msg* pMsg, CUser* pExcludeSender)
{
	CHECK(pMsg);
...
// 在本线程中广播总帮派消息(含子帮派)
void CSyndicate::BroadcastSynMsg(Msg* pMsg, CUser* pExcludeSender)
{
...
//副帮主申请开除会员
bool CSyndicate::ApplyKickoutMember(CUser* pLeader, CUser* pTarget)
{
	DEBUG_TRY
	...
	DEBUG_CATCH("bool CSyndicate::ApplyKickoutMember(CUser* pLeader, CUser* pTarget)")
	return true;
...
DWORD dwBonus 奖金
*/
bool CSyndicate::AllotBonusForMember(CUser* pUser, DWORD dwBonus)
{
