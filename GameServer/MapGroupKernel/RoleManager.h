...
public:
	...
	virtual IRole*		QueryRole(SOCKET_ID idSocket, OBJID idNpc, OBJID idRole=ID_NONE)	PURE_VIRTUAL_FUNCTION_0
...
public:
	virtual void	BroadcastMsg(Msg* pMsg, CUser* pExcludeSender=NULL)					PURE_VIRTUAL_FUNCTION
	virtual void	BroadcastMsg(LPCTSTR szMsg, CUser* pExcludeSender=NULL)					PURE_VIRTUAL_FUNCTION
	virtual void	BroadcastMapGroupMsg(Msg* pMsg, CUser* pExcludeSender=NULL)			PURE_VIRTUAL_FUNCTION
...
public: // interface
	...
	virtual IRole*		QueryRole(SOCKET_ID idSocket, OBJID idNpc, OBJID idRole=ID_NONE);
...
public:
	virtual void	BroadcastMsg(Msg* pMsg, CUser* pExcludeSender=NULL);			// 全世界广播
	virtual void	BroadcastMsg(LPCTSTR szMsg, CUser* pExcludeSender=NULL);			// 全世界广播
public: // mapgroup
	virtual void	BroadcastMapGroupMsg(Msg* pMsg, CUser* pExcludeSender=NULL);			// 本地图组广播
