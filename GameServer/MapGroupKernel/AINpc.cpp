...
bool CMonster::SendMsg(Msg* pMsg)
{
...
void CMonster::BroadcastRoomMsg(Msg* pMsg, bool bSendSelf /*= false*/)
{
...
void CMonster::BroadcastMapMsg(Msg* pMsg, bool bSendSelf /*= false*/)		
{ 
...
{
	uint64 i64OldEffect = m_i64Effect;
	switch (nStatus)
	{
