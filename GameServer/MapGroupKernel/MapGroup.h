...
//	virtual ~IIntraMsg() {}
	...
	virtual bool	SendBroadcastMsg	(Msg* pNetMsg)									PURE_VIRTUAL_FUNCTION_0
	virtual bool	TransmitMsg			(Msg* pNetMsg, SOCKET_ID idSocket, OBJID idNpc)									PURE_VIRTUAL_FUNCTION_0
	virtual bool	TransmitWorldMsg	(Msg* pNetMsg)									PURE_VIRTUAL_FUNCTION_0
	virtual bool	TransmitWorldMsgByName	(SOCKET_ID idSocket, Msg* pNetMsg, LPCTSTR szName)					PURE_VIRTUAL_FUNCTION_0
	virtual bool	TransmitWorldMsgByUserID(Msg* pNetMsg, OBJID idUser)				PURE_VIRTUAL_FUNCTION_0
	//virtual bool	TransmitWorldMsg	(SOCKET_ID idSocket,Msg* pMsg)					PURE_VIRTUAL_FUNCTION_0
...
protected: // IIntraMsg
	...
	virtual bool	SendClientMsg		(SOCKET_ID idSocket, Msg* pMsg);			// to network
	virtual bool	SendNpcMsg			(OBJID idNpc, Msg* pMsg);					// to network
	virtual bool	SendBroadcastMsg	(Msg* pNetMsg);
	virtual bool	TransmitMsg			(Msg* pNetMsg, SOCKET_ID idSocket, OBJID idNpc);		// 广播给其它地图组核心处理
	virtual bool	TransmitWorldMsg	(Msg* pNetMsg);									// 广播给世界核心处理
	virtual bool	TransmitWorldMsgByName	(SOCKET_ID idSocket, Msg* pNetMsg, LPCTSTR szName);					// 通过世界核心转发给玩家
	virtual bool	TransmitWorldMsgByUserID	(Msg* pNetMsg, OBJID idUser);			// 通过世界核心转发给玩家
	//virtual bool	TransmitWorldMsg	(SOCKET_ID idSocket,Msg* pMsg);
